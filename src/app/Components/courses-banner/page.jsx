        ...
        <div className='bg-primary px-4 xl:px-32 py-14'>
            <div className='flex gap-10 flex-col xl:flex-row items-center justify-center'>
                <div className='w-full xl:w-1/2'>
                    <div>
                        <p className='text-white text-xl'>Want to explore Bytenoon in Detail?</p>
                    </div>
                    <div className=' mt-1'>
                        <h1 className='text-2xl md:text-3xl mt-3 font-bold text-white'>
                            <span className='text-secondry'>Schedule </span> a 1:1 call with our
                    ...
                    <div className='mt-5 md:mt-10'>
                        <div className='flex items-center gap-3 mt-10'>
                            ...
                            <p className='text-xl text-white'>For a complete walkthrough of Neovarsity in <br /> detail
                            </p>
                        </div>
                        <div className='flex items-center gap-3 mt-5'>
                            <span><FontAwesomeIcon icon={faCheck} className='text-xl sm:text-3xl text-white' /></span>
                            <p className='text-xl text-white'>Discuss your current requirements & <br /> expectations from a Master’s Degree
                            </p>
                        </div>
                        <div className='flex items-center gap-3 mt-5'>
                            <span><FontAwesomeIcon icon={faCheck} className='text-xl sm:text-3xl text-white' /></span>
                            <p className='text-xl text-white'>Resolve your queries & doubts regarding <br /> the programme
                            </p>
                        </div>
                    </div>
                    <div className='mt-10'>
